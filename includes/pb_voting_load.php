...
function pb_voting_register_actions_filters_after_init()
{
    ...
    add_action( 'wp_ajax_pbvote_save',  array( 'Cgbm_Select_Items_form', 'create_json_file' ));
...
function pb_voting_enqueue_extension()
{
    ...
    wp_register_script('pb-voting',   PB_VOTE_URL . '/assets/js/pbvote-model.js', array('jquery'),'1.1', true);
