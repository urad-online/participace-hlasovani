...
$pom_pages = new PbVote_ProjectSinglePages( get_the_ID() );
$listpage   = $pom_pages->get_voting_page_url();
$editpage   = $pom_pages->get_edit_page_url() ;
$insertpage = $pom_pages->get_insert_page_url();
		...
		while ( have_posts() ) : the_post();
            ...
            <div class="imc-SingleHeaderStyle imc-BGColorWhite">
				...
				<?php if(pb_user_can_edit(get_the_ID(), $user_id)) { ?>
                    <a href="<?php echo $editpage; ?>" class="u-pull-right imc-SingleHeaderLinkStyle">
                                ...
                                <div class="imc-row">
                                    ...
                                    <div class="imc-grid-2 imc-columns">
										...
										<?php }	else { ?>
                                            ...
                                            <img src="<?php echo esc_url(plugins_url()); ?>/improve-my-city/img/ic_default_cat.png" class="imc-SingleCategoryIcon">
										...
										if ($user_id === intval(get_the_author_meta('ID'), 10) ) { ?>
                                            <div class="imc-CardLayoutStyle imc-CenterContents">
                                                <img alt="My Issue icon" class="imc-VerticalAlignMiddle"
                                                     ...
                                                     src="<?php echo esc_url(plugins_url('improve-my-city/img/ic_my_issue_grid.png')); ?>">
                                                <span
