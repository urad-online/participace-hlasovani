 ...
 * Template Name: Insert Voting Page
...
if(isset($_POST['submitted']) && isset($_POST['post_nonce_field']) && wp_verify_nonce($_POST['post_nonce_field'], 'post_nonce')) {
	...
	$post_id = $project_save->project_insert( $voting_page_id );

	if($post_id){

		// wp_redirect(get_permalink($listpage[0]->ID));
		wp_redirect(get_permalink($voting_page_id));
...
?>
    <div class="imc-BGColorGray">
        <div class="imc-SingleHeaderStyle imc-BGColorWhite">
            <a href="<?php echo esc_url(get_permalink($voting_page_id)); ?>" class="u-pull-left imc-SingleHeaderLinkStyle ">
