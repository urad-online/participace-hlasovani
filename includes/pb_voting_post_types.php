...
function pbvote_register_post_type()
{
    $labels = array(
        ...
        'add_new_item'       => __( 'Přidat hlasování', 'pb-voting' ),
        'edit_item'          => __( 'Upravit  hlasování', 'pb-voting' ),
        'new_item'           => __( 'Nové hlasování', 'pb-voting' ),
        'all_items'          => __( 'Všechna hlasování', 'pb-voting' ),
        'view_item'          => __( 'Přehled hlasování', 'pb-voting' ),
        'search_items'       => __( 'Hledat hlasování', 'pb-voting' ),
        'not_found'          => __( 'Žádné hlasování nalezeno', 'pb-voting' ),
        'not_found_in_trash' => __( 'Žádné hlasování nalezeno v koši', 'pb-voting' ),
        'parent_item_colon'  => '',
